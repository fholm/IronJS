...
namespace IronJS.Compiler.Ast {
    ...
    public class Function : Node {
        ...
        public Function(Variable name, IEnumerable<string> parameters, INode body, ITree node)
        ...
        internal IjsIVar GetNonLocal(string name) {
            ...
            HashSet<Function> parentFunctions = new HashSet<Function>();
            ...
            while (true) {
                if (parent.IsLocal(name) || parent.IsParameter(name)) {
                    if (parent.IsGlobalScope) {
                        ...
                        foreach (Function subParent in parentFunctions)
