...
namespace IronJS.Tests.UnitTests.Sputnik.Conformance.Expressions.PostfixExpressions
{
    ...
    public class PostfixDecrementOperatorTests : SputnikTestFixture
    {
        ...
        {
            RunFile_ExpectException(@"S11.3.2_A1.1_T1.js");
        }
        ...
        {
            RunFile_ExpectException(@"S11.3.2_A1.1_T2.js");
        }
        ...
        {
            RunFile_ExpectException(@"S11.3.2_A1.1_T3.js");
        }
        ...
        {
            RunFile_ExpectException(@"S11.3.2_A1.1_T4.js");
        }
        ...
        {
            RunFile_ExpectException(@"S11.3.2_A2.1_T3.js");
        }
