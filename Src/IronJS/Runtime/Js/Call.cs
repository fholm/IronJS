...
namespace IronJS.Runtime.Js.Proxies {
	public class IjsCall<T0> {
		...
		public Func<Closure, T0, object> Delegate;
	...
	public class IjsCall<T0, T1> {
		...
		public Func<Closure, T0, T1, object> Delegate;
	...
	public class IjsCall<T0, T1, T2> {
		...
		public Func<Closure, T0, T1, T2, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3> {
		...
		public Func<Closure, T0, T1, T2, T3, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, object> Delegate;
	...
	public class IjsCall<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> {
		...
		public Func<Closure, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, object> Delegate;
