...
namespace IronJS.Tests.UnitTests.Sputnik.Conformance.NativeECMAScriptObjects.StringObjects.PropertiesOfTheStringPrototypeObject
{
    ...
    public class StringPrototypeToLocaleLowerCaseTests : SputnikTestFixture
    {
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 15.5.4.17")]
        [Description("The String.prototype.toLocaleLowerCase.length property has the attribute ReadOnly")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 15.5.4.17")]
        [Description("The length property of the toLocaleLowerCase method is 0")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 15.5.4.17")]
        [Description("String.prototype.toLocaleLowerCase() return a string, but not a String object")]
        ...
        [Description("String.prototype.toLocaleLowerCase has not prototype property")]
        ...
        [TestCategory("ECMA 15.5.4.17")]
        [TestCategory("ECMA 13.2")]
        [Description("String.prototype.toLocaleLowerCase can\'t be used as constructor")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 15.5.4.17")]
        [Description("The String.prototype.toLocaleLowerCase.length property has the attribute DontEnum")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 15.5.4.17")]
        [Description("The String.prototype.toLocaleLowerCase.length property has the attribute DontDelete")]
