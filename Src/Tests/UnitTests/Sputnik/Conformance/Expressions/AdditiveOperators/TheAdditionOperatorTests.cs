...
namespace IronJS.Tests.UnitTests.Sputnik.Conformance.Expressions.AdditiveOperators
{
    ...
    public class TheAdditionOperatorTests : SputnikTestFixture
    {
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 11.6.1")]
        [Description("If Type(Primitive(x)) is not String and Type(Primitive(y)) is not String, then operator x + y returns ToNumber(x) + ToNumber(y)")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 11.6.1")]
        [Description("If Type(Primitive(x)) is String or Type(Primitive(y)) is String, then operator x + y returns the result of concatenating ToString(x) followed by ToString(y)")]
        ...
        [Description("The result of an addition is determined using the rules of IEEE 754 double-precision arithmetics")]
