...
namespace IronJS.Tests.UnitTests.Sputnik.Conformance.Expressions.RelationalOperators
{
    ...
    public class TheGreaterThanOperatorTests : SputnikTestFixture
    {
        ...
        [TestCategory("ECMA 11.8.2")]
        [TestCategory("ECMA 7.2")]
        [TestCategory("ECMA 7.3")]
        [Description("White Space and Line Terminator between RelationalExpression and \">\" or \">\" and ShiftExpression are allowed")]
        ...
        [TestCategory("Sputnik Conformance")]
        [TestCategory("ECMA 11.8.2")]
        [Description("If Type(Primitive(x)) is String and Type(Primitive(y)) is String, then operator x > y returns ToString(x) > ToString(y)")]
        ...
        [TestCategory("ECMA 11.8.2")]
        [TestCategory("ECMA 11.8.5")]
        [Description("If is x greater than y and these values are both finite non-zero, return true")]
